...
def initializeTrackbars(intialTracbarVals):
    cv2.namedWindow("Trackbars")
    cv2.resizeWindow("Trackbars", 360, 490)
    cv2.createTrackbar("X Top left", "Trackbars", intialTracbarVals[0], 50, nothing)
    cv2.createTrackbar("X Top right", "Trackbars", intialTracbarVals[1], 50, nothing)
    cv2.createTrackbar("Y Top left", "Trackbars", intialTracbarVals[2], 100, nothing)
    cv2.createTrackbar("Y Top right", "Trackbars", intialTracbarVals[3], 100, nothing)

    cv2.createTrackbar("X Bottom left", "Trackbars", intialTracbarVals[4], 50, nothing)
    cv2.createTrackbar("X Bottom right", "Trackbars", intialTracbarVals[5], 50, nothing)
    cv2.createTrackbar("Y Bottom left", "Trackbars", intialTracbarVals[6], 100, nothing)
    cv2.createTrackbar("Y Bottom right", "Trackbars", intialTracbarVals[7], 100, nothing)
...
#     return src
def valTrackbars():
    xTopLeft = cv2.getTrackbarPos("X Top left", "Trackbars")
    xTopRight = cv2.getTrackbarPos("X Top righ", "Trackbars")
    yTopLeft = cv2.getTrackbarPos("Y Top left", "Trackbars")
    yTopRight = cv2.getTrackbarPos("Y Top right", "Trackbars")

    xBottomLeft = cv2.getTrackbarPos("X Bottom left", "Trackbars")
    xBottomRight = cv2.getTrackbarPos("X Bottom right", "Trackbars")
    yBottomLeft = cv2.getTrackbarPos("Y Bottom left", "Trackbars")
    yBottomRight = cv2.getTrackbarPos("Y Bottom right", "Trackbars")


    # src = np.float32([(xTopLeft / 100, yTopLeft / 100), (1 - (xTopRight / 100), yTopRight / 100),
    #                   (xBottomLeft / 100, yBottomLeft / 100), (1 - (xBottomRight / 100), yBottomRight / 100)])
    src = np.float32([(xTopLeft / 100, yTopLeft / 100), (0.6 - (xTopRight / 100), yTopRight / 100),
                      (xBottomLeft / 100, yBottomLeft / 100), (1 - (xBottomRight / 100), yBottomRight / 100)])
    # src = np.float32([(0.43, 0.65), (0.58, 0.65), (0.1, 1), (1, 1)])
    return src
