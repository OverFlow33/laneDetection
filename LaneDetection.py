...
if cameraFeed:intialTracbarVals = [24,55,12,100] #  #wT,hT,wB,hB
else:intialTracbarVals = [42, 42, 63, 63, 14, 14, 87, 87]   #wT,hT,wB,hB
...
while True:
    ...
    try:
        ...
        if averageCurve >= 30:
            ...
            turn = 'stay in center'
        cv2.putText(imgFinal, turn, (frameWidth//2-70, 70), cv2.FONT_HERSHEY_DUPLEX, 1.75, (0, 0, 255), 2, cv2.LINE_AA)
